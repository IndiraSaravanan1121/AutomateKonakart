...
public class Constants {
	...
	public static final String LOCATOR_PATH = "./src/test/resources/Locator/locator.properties";
	...
	public static final String SAUCE_PATH="./src/test/resources/pageobjects/sauce.properties";
